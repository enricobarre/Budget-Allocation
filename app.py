...
st.title("OECD Budget Optimizer 🇮🇹")
...
if "Population" not in df.columns:
    st.error("❌ ERROR: 'Population' column is missing in `final_investment_table.csv`")
    st.stop()
...
regioni_sel = st.multiselect("Seleziona una o più regioni (o lascia vuoto per tutte)", regioni)
